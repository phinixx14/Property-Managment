...
namespace PropertyManagment
{
    ...
    public class Property
    {
        ...
        //private Features _propertyFeatures = null;
        ...
        {
            get; set;
            //get { return ReferenceEquals(null, _propertyFeatures) ? new Features() : _propertyFeatures; }
        ...
        {
            return PropertyList.Find(i => i.PropertyID == id);
        }
