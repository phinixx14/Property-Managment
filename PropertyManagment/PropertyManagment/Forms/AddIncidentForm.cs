    ...
    public partial class AddIncidentForm : Form
    {
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            if (FieldsAreValid())
            {
                ...
                Cost = Convert.ToDouble(txt_MoneyChargedToTenant.Text); 
                Incident.CreateIncident(IncidentName, Description, Date, property, Status, tenants, TenantIsLiable, PetRelated, Cost);
